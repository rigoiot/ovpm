...
export default class UserEdit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      ipAllocationMethod: this.props.ipAllocationMethod
        ...
        : "dynamic",
      pushGW: this.props.pushGW != undefined ? this.props.pushGW : false,
      isAdmin: this.props.isAdmin ? this.props.isAdmin : false,
      isDevice: this.props.isDevice ? this.props.isDevice : false,
      deviceSubnet: this.props.deviceSubnet ? this.props.deviceSubnet : ""
    };
  }
  ...
  handleIsDeviceChange(e) {
    this.setState({ isDevice: e.target.checked });
  }

  handleDeviceSubnetChange(e) {
    this.setState({ deviceSubnet: e.target.value });
  }
  ...
  render() {
    ...
    var deviceSubnetInput;
    if (this.state.isDevice) {
      deviceSubnetInput = (
        <Input
          label="Device SubNet"
          value={this.state.deviceSubnet}
          onChange={this.handleDeviceSubnetChange.bind(this)}
          floatingLabel={true}
          required={true}
          disabled={this.props.isDevicSubnetDisabled}
        />
      );
    }
    return (
      <Container>
        ...
        <Checkbox
          ...
          onChange={this.handleIsDeviceChange.bind(this)}
        />
        {deviceSubnetInput}
